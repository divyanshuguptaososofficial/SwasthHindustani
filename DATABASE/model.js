...
g_ClientMfc.removeAttribute('id')
//--------Model of country----
...
g_sequelize.sync({ force: false })
  .then(() => {
   ...
   g_Hospital.hasMany(g_Services,{ foreignKey : 'hs_id' });
   g_Services.belongsTo(g_Hospital,{foreignKey: 'hs_id'});   
